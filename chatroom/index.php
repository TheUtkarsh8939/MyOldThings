...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      ...
      Pragychat.com/</br><input type="text" name="room" class="form-control"></input>
      <br><button class="btn btn-outline-secondary" href="#">Create room</button>
      </div>
      </form>
    </div>
